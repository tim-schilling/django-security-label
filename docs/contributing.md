...
```bash
docker run -d -e POSTGRES_PASSWORD=django-security-label -e POSTGRES_USER=django-security-label -p 5432:5432 registry.gitlab.com/dalibo/postgresql_anonymizer
```
